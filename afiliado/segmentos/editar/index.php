...
<?php
  ...
  $edit = mysqli_query( $db_con, "SELECT * FROM segmentos WHERE id = '$id' LIMIT 1");
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_segmento( $id,$nome,$icone,$censura ) ) {
	...
	<div class="container">
        ...
        <div class="bread-box pull-right">
          <div class="bread">
            ...
            <span>/</span>
            <a href="<?php afiliado_url(); ?>/segmentos/editar?id=<?php echo $id; ?>">Editar</a>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="file-preview">
                ...
                <div class="image-preview image-preview-product" id="image-preview" style='background: url("<?php echo imager( $data['icone'] ); ?>") no-repeat center center; background-size: auto 102%;'>
              ...
              <div class="form-field-default">
                  ...
                  <div class="radios">
                    ...
                    <div class="form-field-radio">
                      <input type="radio" name="censura" value="1" <?php if( $data['censura'] == 1 OR !$data['censura'] ){ echo 'CHECKED'; }; ?>> Sim
                    </div>
                    <div class="form-field-radio">
                      <input type="radio" name="censura" value="2" <?php if( $data['censura'] == 2 ){ echo 'CHECKED'; }; ?>> Não
                    </div>
                    <div class="clear"></div>
                  </div>
