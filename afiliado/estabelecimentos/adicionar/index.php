	...
	<div class="container">
        ...
        <div class="bread-box pull-right">
          <div class="bread">
            ...
            <span>/</span>
            <a href="<?php afiliado_url(); ?>/estabelecimentos/adicionar">Adicionar</a>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <label>Google maps ( Opcional )</label>
                        <span class="form-tip">Link do botão como chegar ao estabelecimento pelo mapa</span>
                        <input type="text" name="contato_youtube" placeholder="Digite o link do google maps" value="<?php echo htmlclean( $_POST['contato_youtube'] ); ?>">
