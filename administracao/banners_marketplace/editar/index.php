...
<?php
  ...
  $edit = mysqli_query( $db_con, "SELECT * FROM banners_marketplace WHERE id = '$id' LIMIT 1");
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( edit_banner_marketplace( $id,$estabelecimento,$titulo,$desktop,$mobile,$video_link,$link,$status ) ) {
      ...
      <div class="col-md-12">
        ...
        <div class="bread-box pull-right">
          <div class="bread">
            ...
            <span>/</span>
            <a href="<?php admin_url(); ?>/banners_marketplace/editar?id=<?php echo $id; ?>">Editar</a>
          </div>
        </div>
