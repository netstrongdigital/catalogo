...
$query .= "SELECT * FROM banners_marketplace ";
...
$query .= "AND rel_estabelecimentos_id = '1' ";
	...
	<div class="container">
			...
			<div class="col-md-12">
				...
				<div class="bread-box pull-right">
					<div class="bread">
						...
						<span>/</span>
						<a href="<?php admin_url(); ?>/banners_marketplace">Banners</a>
					</div>
				</div>
						...
						<div id="collapse-filtros" class="panel-collapse collapse <?php if( $_GET['filtered'] ) { echo 'in'; }; ?>">
							<div class="panel-body">
								...
								<form class="form-filters form-100" method="GET">
									...
									<div class="row">
										<div class="col-md-12">
										    <a href="<?php admin_url(); ?>/banners_marketplace" class="limpafiltros"><i class="lni lni-close"></i> Limpar filtros</a>
										</div>
									</div>
									<?php } ?>
								</form>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php admin_url(); ?>/banners_marketplace/adicionar">
							<span>Adicionar</span>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php admin_url(); ?>/banners_marketplace/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este banner?')) document.location = '<?php admin_url(); ?>/banners_marketplace/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
        ...
        <div class="paginacao">
          ...
          <ul class="pagination">
            ...
            <?php
            $paginationpath = "banners_marketplace";
            if($pagina > 1) {
              $back = $pagina-1;
