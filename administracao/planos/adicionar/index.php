...
<?php
  ...
  if( $formdata ) {
    ...
    $comissionamento = mysqli_real_escape_string( $db_con, $_POST['comissionamento'] );
    ...
    $funcionalidade_disparador = mysqli_real_escape_string( $db_con, $_POST['funcionalidade_disparador'] );
    ...
    // Executar registro
      ...
      if( !$checkerrors ) {
        ...
        if( new_plano( $destaque,$nome,$descricao,$comissionamento,$duracao_meses,$duracao_dias,$valor_total,$valor_mensal,$link,$termos,$funcionalidade_disparador,$funcionalidade_marketplace,$funcionalidade_variacao,$funcionalidade_banners,$visible,$status,$ordem,$limite_produtos ) ) {
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              ...
              <div class="form-field-default">
                  ...
                  <input type="number" name="duracao_meses" placeholder="Duração (em meses)" min="0" max="120" value="<?php echo htmlclean( $_POST['duracao_meses'] ); ?>">
           ...
           <!--<div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <label>Habilita comissionamento?</label>
                  <div class="radios">
                    <div class="spacer"></div>
                    <div class="form-field-radio">
                      <input type="radio" name="comissionamento" value="1" <?php if( $_POST['comissionamento'] == 1 OR !$_POST['comissionamento'] ){ echo 'CHECKED'; }; ?>> Sim
                    </div>
                    <div class="form-field-radio">
                      <input type="radio" name="comissionamento" value="2" <?php if( $_POST['comissionamento'] == 2 ){ echo 'CHECKED'; }; ?>> Não
                    </div>
                    <div class="clear"></div>
                  </div>
          ...
          <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="form-field-default">
                    ...
                    <label>Habilita disparador?</label>
                    <div class="radios">
                      <div class="spacer"></div>
                      <div class="form-field-radio">
                        <input type="radio" name="funcionalidade_disparador" value="1" <?php if( $data['funcionalidade_disparador'] == 1 ){ echo 'CHECKED'; }; ?>> Sim
                      </div>
                      <div class="form-field-radio">
                        <input type="radio" name="funcionalidade_disparador" value="2" <?php if( $data['funcionalidade_disparador'] == 2 OR !$data['funcionalidade_disparador'] ){ echo 'CHECKED'; }; ?>> Não
                      </div>
                      <div class="clear"></div>
                    </div>
