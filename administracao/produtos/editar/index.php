      ...
      <div class="col-md-12">
        ...
        <div class="bread-box pull-right">
          <div class="bread">
            ...
            <span>/</span>
            <a href="<?php admin_url(); ?>/produtos/editar?id=<?php echo $id; ?>">Editar</a>
          </div>
        </div>
               ...
               <label>Categoria:</label>
                  <div class="fake-select">
                    ...
                    <select id="input-categoria" name="categoria">
                      ...
                      <option value=""></option>
                      <?php 
                      $cid = $data['rel_estabelecimentos_id'];
                      $quicksql = mysqli_query( $db_con, "SELECT * FROM categorias WHERE rel_estabelecimentos_id = '$cid' ORDER BY nome ASC LIMIT 999" );
