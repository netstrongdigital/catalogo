			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php admin_url(); ?>/cidades/adicionar">
							<span>Adicionar</span>
					...
					<table class="listing-table fake-table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    <span class="fake-table-title">Estado</span>
                                    <div class="fake-table-data"><?php echo htmlclean( data_info("estados",$data['estado'],"nome") ); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php admin_url(); ?>/cidades/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover esta cidade?')) document.location = '<?php admin_url(); ?>/cidades/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
