			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php admin_url(); ?>/estados/adicionar">
							<span>Adicionar</span>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php admin_url(); ?>/estados/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este estado?')) document.location = '<?php admin_url(); ?>/estados/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
