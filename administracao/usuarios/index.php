...
$usuario_tipo = mysqli_real_escape_string( $db_con, $_GET['usuario_tipo'] );
...
//DESMARCAR PARA MOSTRAR SOMENTE USUARIOS COM LEVEL ESPECIFICO
//$query .= "AND level = '3' ";
								...
								<form class="form-filters form-100" method="GET">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-field-default">
												<label>E-mail:</label>
												<input type="text" name="email" placeholder="E-mail" value="<?php echo htmlclean( $email ); ?>"/>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-field-default">
											...
											<div class="form-field-default">
												...
												<div class="fake-select">
													...
													<select name="usuario_tipo">
			                                            ...
			                                            <option value="<?php echo $numeric_data['usuario_tipo'][$x]['value']; ?>" <?php if( $usuario_tipo == $numeric_data['usuario_tipo'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['usuario_tipo'][$x]['name']; ?></option>
			                                            <?php } ?>
													</select>
													<div class="clear"></div>
												</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php admin_url(); ?>/usuarios/adicionar">
							<span>Adicionar</span>
				...
				<div class="col-md-12">
					...
					<table class="listing-table fake-table">
						...
						<tbody>
							...
							<tr>
								<td>
                                    <div class="fake-table-data"><i class="rep-icon lni lni-user"></i></div>
								...
								<td>
                                    <span class="fake-table-title">E-mail</span>
                                    <div class="fake-table-data"><?php echo htmlclean( $data['email'] ); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td>
								...
								<td>
                                    <span class="fake-table-title">Level</span>
                                    <div class="fake-table-data"><?php echo numeric_data( "level", $data['level'] ); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php admin_url(); ?>/usuarios/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este usuário?')) document.location = '<?php admin_url(); ?>/usuarios/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
