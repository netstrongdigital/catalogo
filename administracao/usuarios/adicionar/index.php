              ...
              <div class="form-field-default">
                  ...
                  <div class="fake-select">
                    ...
                    <select name="usuario_tipo">
                      ...
                      <?php for( $x = 0; $x < count( $numeric_data['level'] ); $x++ ) { ?>
                      <option value="<?php echo $numeric_data['level'][$x]['value']; ?>" <?php if( $_POST['level'] == $numeric_data['level'][$x]['value'] ) { echo 'SELECTED'; }; ?>><?php echo $numeric_data['level'][$x]['name']; ?></option>
                      <?php } ?>
                    </select>
                    <div class="clear"></div>
              	</div>
