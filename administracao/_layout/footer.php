		...
		<script src="<?php just_url(); ?>/_core/_cdn/datepicker/js/bootstrap-datepicker.min.js"></script>
		<script src="<?php just_url(); ?>/_core/_cdn/datepicker/locales/bootstrap-datepicker.br.min.js"></script>
