						...
						<div id="collapse-filtros" class="panel-collapse collapse <?php if( $_GET['filtered'] ) { echo 'in'; }; ?>">
							<div class="panel-body">
								...
								<form class="form-filters form-100" method="GET">
									...
									<div class="row">
										<div class="col-md-12">
										    <a href="<?php admin_url(); ?>/banners" class="limpafiltros"><i class="lni lni-close"></i> Limpar filtros</a>
										</div>
									</div>
									<?php } ?>
								</form>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php admin_url(); ?>/banners/adicionar">
							<span>Adicionar</span>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php admin_url(); ?>/banners/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este banner?')) document.location = '<?php admin_url(); ?>/banners/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
