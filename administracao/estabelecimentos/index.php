...
$query .= "SELECT id,nome,perfil,cidade,estado,status,excluded,subdominio,email FROM estabelecimentos ";
								...
								<form class="form-filters form-100" method="GET">
									...
									<!--<div class="col-md-4">
											...
											<div class="form-field-default">
												...
												<input type="text" name="email" placeholder="Email" value="<?php echo htmlclean( $email ); ?>"/>
						...
						<tbody>
							...
							<tr>
								...
								<td>
                                    ...
                                    <span class="fake-table-title">Email</span>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										...
										<div class="form-actions pull-right">
										    ...
										    <a class="color-blue" onclick="if(confirm('Tem certeza que deseja duplicar este estabelecimento?')) document.location = '<?php admin_url(); ?>/estabelecimentos/admgerenciar/?id=<?php echo $data['id']; ?>&mode2=<?php echo $_GET['mode2']; ?>'" href="#" title="duplicar"><i class="lni lni-layers"></i></a>
