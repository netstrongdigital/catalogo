								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											...
											<a class="color-red" href = "<?php admin_url(); ?>/pedidos/excluir/?id=<?php echo $data['id']; ?>&nome=<?php echo $data['nome']; ?>&whats=<?php echo $data['whatsapp']; ?>" title="Excluir Pedido"><i class="lni lni-trash"></i></a>
											
											<!-- Antigo Botão de Excluir -->
