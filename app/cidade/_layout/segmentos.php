...
$query_categorias = 
"
SELECT segmentos.nome as segmento_nome,segmentos.id as segmento_id, segmentos.icone as segmento_icone 
...
<a class="<?php if( $data_categoria['segmento_id'] == $categoria ){ echo 'active'; }; ?>" href="<?php echo $app['url']; ?>/<?php echo $gopath; ?>/?categoria=<?php echo $data_categoria['segmento_id']; ?><?php if( $query_busca ) { echo "&".$query_busca; }; ?>">
	<span><img style="max-width: 20px;" src="../../../_core/_uploads/<?php echo $data_categoria['segmento_icone']; ?>" /> <?php echo $data_categoria['segmento_nome']; ?></span>
</a>
<?php } ?>
