...
// IMPORT DAS VARIÁVEIS DE CONFIGURAÇÃO
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="mini-links pull-right">
						...
						<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp ?>&text=Olá, preciso de ajuda!"><i class="lni lni-headphone-alt"></i> Fale conosco</a>
