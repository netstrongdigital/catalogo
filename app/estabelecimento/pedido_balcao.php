      ...
      if( $pedido = new_pedido(
		...
		$mesa
    		...
    		//Getnet
    			...
    			header("Location: ".$app['url']."/pix?pedido=".$pedido."&forma=".$forma_pagamento."&codex=".$vpedido."&taxa=".$tpedido);
			...
			<div class="container nopaddmobile">
				...
				<div class="row rowtitle">
					...
					<div class="col-md-12">
						...
						<div class="bread-box">
							<div class="bread">
								<a href="<?php echo $app['url']; ?>/sacola.php">Voltar para Sacola</a>
							</div>
						</div>
					</div>
										      ...
										      <label>Forma de entrega:</label>
												<div class="fake-select">
													...
													<select id="input-forma-entrega" name="forma_entrega">
													  ...
													  <option <?php if( $_SESSION['checkout']['forma_entrega'] == "retirada" OR !$_SESSION['checkout']['forma_entrega'] ) { echo 'SELECTED'; }; ?> value="retirada">Retirar no Balcao</option>
													  <?php } ?>
...
$( ".botao-aplicar" ).click(function() {
	...
	var gourl = "<?php echo $app['url'].'/pedido_balcao?cupom=';?>"+cupom;
...
$( "#input-forma-pagamento" ).change(function() {
	...
	if( forma_pagamento == "6" ) {
		$( ".elemento-forma-pagamento-descricao" ).show();
		$( ".elemento-forma-pagamento-descricao label" ).html("Informe seu CPF:");
		$( ".elemento-forma-pagamento-descricao input" ).attr("placeholder","Apneas números");
		$( ".elemento-forma-pagamento-descricao .form-tip" ).hide();
	}
