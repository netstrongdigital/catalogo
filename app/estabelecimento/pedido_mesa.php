										      ...
										      <label>Forma de entrega:</label>
												<div class="fake-select">
													...
													<select id="input-forma-entrega" name="forma_entrega">
													  ...
													  <option <?php if( $_SESSION['checkout']['forma_entrega'] == "mesa" OR !$_SESSION['checkout']['forma_entrega'] ) { echo 'SELECTED'; }; ?> value="mesa">Entregar na mesa:</option>
													  <?php } ?>
									...
									<div class="row">
										...
										<div class="col-md-12">
										  ...
										  <div class="form-field-default">
										      ...
										      <input type="text" name="numero_mesa" placeholder="digite o Nº da mesa" value="<?php echo htmlclean( $_SESSION['checkout']['numero_mesa'] ); ?>">
