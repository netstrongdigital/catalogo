									...
									<div class="row">
										...
										<div class="col-md-12">
										  ...
										  <div class="form-field-default">
										      ...
										      <input type="text" name="nome" placeholder="Nome:aaaaaaaaaaa" <?php if(isset($_COOKIE['nomecli'])){ ?> value="<?php print $_COOKIE['nomecli']; ?>" <?php } else { ?> value="<?php echo htmlclean( $_SESSION['checkout']['nome'] ); ?>" <?php } ?>>
