...
<?php echo $acompanhamento_finalizacao; ?>
					...
					<div class="obrigado">
						...
						<div class="row">
							...
							<div class="col-md-12" align="center">
							  ...
							  <!--  <p> Olá <strong><?php if(isset($_COOKIE['nomecli'])){ ?><?php print $_COOKIE['nomecli']; ?><?php } ?></strong>, Após realizar o pagamento, clique no botão abaixo para confirmar o pedido.</p>
...
<p style="text-align: center;">
    Olá <strong>
        <?php if(isset($_COOKIE['nomecli'])) { echo $_COOKIE['nomecli']; } ?>
    </strong>, Após realizar o pagamento, clique no botão abaixo para confirmar o pedido enviando o comprovante pelo WhatsApp.
</p>

<div style="display: flex; flex-direction: column; align-items: center; gap: 15px; margin-top: 15px;">
    <!-- Botão de confirmação para enviar comprovante pelo WhatsApp -->
    <a target="_blank" href="<?php echo $whatsapp_link; ?>" class="botao-acao" 
       style="display: flex; align-items: center; justify-content: center; padding: 10px 20px; background-color: #25D366; color: white; font-size: 16px; text-decoration: none; border-radius: 5px; width: 100%; max-width: 300px;">
        <i class="lni lni-whatsapp" style="margin-right: 8px;"></i>
        <span>Já fiz o PIX</span>
    </a>
</div>
