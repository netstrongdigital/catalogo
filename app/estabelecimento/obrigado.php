					...
					<div class="obrigado">
						...
						<div class="row">
							...
							<div class="col-md-12" align="center">
							    ...
							    <p> Olá <strong><?php if(isset($_COOKIE['nomecli'])){ ?><?php print $_COOKIE['nomecli']; ?><?php } ?></strong>, Após realizar o pagamento, clique no botão abaixo confirmar o pedido.</p>
							    
							    <a target="_blank" href="<?php echo $whatsapp_link; ?>" class="botao-acao"><i class="lni lni-whatsapp"></i> <span>Já fiz o PIX Envia Comprovante!</span></a>
                                <br/>
                                
                                
                                <br/>
                                <p><strong>Confirme o pagamento em até 5 minutos</strong></p>
                                <div class="progress">
...
<div class="adicionado">
									...
									<i class="checkicon lni lni-checkmark-circle"></i>
									<span class="text"><span>Olá <strong><?php if(isset($_COOKIE['nomecli'])){ ?><?php print $_COOKIE['nomecli']; ?><?php } ?></strong></span>, o seu pedido foi efetuado com sucesso. Para facilitar clique no botão abaixo para enviar via whatsapp!</span>
