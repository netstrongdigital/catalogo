			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php panel_url(); ?>/frete/adicionar">
							<span>Adicionar</span>
						...
						<tbody>
							...
							<tr>
								<td class="hidden-xs hidden-sm">
                                    <div class="fake-table-data"><i class="rep-icon lni lni-delivery"></i></div>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">R$ <?php echo htmlclean( dinheiro( $data['valor'], "BR") ); ?></div>
                                    <div class="fake-table-break"></div>
								</td>
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php panel_url(); ?>/frete/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este frete?')) document.location = '<?php panel_url(); ?>/frete/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
