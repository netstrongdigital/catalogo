...
restrict_expirado();
// SEO
$seo_subtitle = "Opções de Entrega";
$seo_description = "";
$seo_keywords = "";
// HEADER
$system_header .= "";
						...
						<div id="collapse-filtros" class="panel-collapse collapse <?php if( $_GET['filtered'] ) { echo 'in'; }; ?>">
							<div class="panel-body">
								...
								<form class="form-filters form-100" method="GET">
									...
									<div class="row">
										<div class="col-md-12">
										    <a href="<?php panel_url(); ?>/frete" class="limpafiltros"><i class="lni lni-close"></i> Limpar filtros</a>
										</div>
									</div>
									<?php } ?>
								</form>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="add-new pull-right">
						...
						<a href="<?php panel_url(); ?>/local/adicionar">
							<span>Adicionar</span>
				...
				<div class="col-md-12">
					...
					<table class="listing-table normal-table">
						...
						<tbody>
							...
							<tr>
								<td>
                                    <span class="fake-table-title">QRCode</span>
                                    <div class="fake-table-data">
                                        <a href="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo $meudominio; ?>/?local=<?php echo htmlclean( $data['id'] ); ?>&amp;size=400x400" target="_blank"><img src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo $meudominio; ?>/?local=<?php echo htmlclean( $data['id'] ); ?>&amp;size=100x100" alt="" title="" class="img-thumbnail"/></a>
                                    </div>
								...
								<td>
                                    ...
                                    <div class="fake-table-data">
										<div class="form-actions pull-right">
											<a class="color-yellow" href="<?php panel_url(); ?>/local/editar?id=<?php echo $data['id']; ?>" title="Editar"><i class="lni lni-pencil"></i></a>
											<a class="color-red" onclick="if(confirm('Tem certeza que deseja remover este frete?')) document.location = '<?php panel_url(); ?>/local/deletar/?id=<?php echo $data['id']; ?>'" href="#" title="Excluir"><i class="lni lni-trash"></i></a>
										</div>
                                    </div>
                                    <div class="fake-table-break"></div>
								</td>
