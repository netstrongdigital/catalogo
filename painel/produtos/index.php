							...
							<tr>
								...
								<td>
									...
									<div class="fake-table-data">
										...
										// Corrigindo a lógica de exibição do estoque

										if ($data['estoque'] == "1") {

											echo "Não controla estoque";

										} else {

											echo htmlclean($data['posicao']); // Exibe o estoque mesmo que seja 0 ou negativo
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
		...
		<h4 class="modal-title">Mensagem que será enviada aos clientes.</h4>
