...
<?php
  ...
  if( $formdata ) {
    ...
    if( !$checkerrors ) {
      ...
      if( $pid = new_produto( $eid,$categoria,$destaque,$estoque,$posicao,$ref,$nome,$video_link,$descricao,$valor,$oferta,$valor_promocional,$variacao,$visible,$status,$visible,$integrado ) ) {
      ...
      <div class="col-md-12">
        ...
        <div class="bread-box pull-right">
          <div class="bread">
            ...
            <span>/</span>
            <a href="<?php panel_url(); ?>/produtos/editar?id=<?php echo $id; ?>">Copiar</a>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <?php if( $_GET['msg'] == "sucesso" ) { ?>
                ...
                <?php modal_alerta("Copiado com sucesso!","sucesso"); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-field-default">
                  ...
                  <label>Link do vídeo destaque:</label>
                  <input type="text" name="video_link" placeholder="Link do vídeo" value="<?php echo htmlclean( $data['video_link'] ); ?>">
