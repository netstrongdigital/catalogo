...
// Mapeando subdominio
  ...
  if( $has_insubdominio ) {
    ...
    if( $insubdominiotipo == "1" ) {
      ...
      if( $inacao == "pedido_frete" ) {



        $chamar = $virtualpath."/pedido_frete.php";
      ...
      if( $inacao == "mercadopago_webhook" ) {

        $chamar = $virtualpath."/mercadopago/mercadopago_webhook.php";
      ...
      if( $inacao != "index.html" && $inacao != "serviceworker.js" && $inacao != "shopping.xml" && $inacao != "pix" && $inacao != "addtohome.js" && $inacao != "manifest.webmanifest" && $inacao != "favicon.png" && $inacao != "categoria" && $inacao != "produto" && $inacao != "sacola" && $inacao != "pedido" && $inacao != "pedido_frete" && $inacao != "pedido_delivery" && $inacao != "pedido_balcao" && $inacao != "pedido_mesa"  && $inacao != "pedido_outros" && $inacao != "pedidosabertos" && $inacao != "pedidosfechados" && $inacao != "desativado" && $inacao != "fechado" && $inacao != "obrigado" && $inacao != "" && $inacao != "mercadopago" && $inacao != "pagseguro" && $inacao != "getnet" && $inacao != "getnet_process" && $inacao != "getnet_status" && $inacao != "pagseguro_id" && $inacao != "pagseguro_process" && $inacao != "pagseguro_create_payment" && $inacao != "pagseguro_status" && $inacao != "mercadopago_process" && $inacao != "mercadopago_status" && $inacao != "mercadopago_webhook") {
    ...
    if( $insubdominio ) {
      ...
      header("Location: https://$dominio/conheca");
